...
!~~~~~~> local variables
  ...
  !   write(*,*)'[DEBUG prolong3] ghost_width==2 (4-pt, line 1227) called, extc=',extc,' extf=',extf
  if(wei.ne.3)then
...
!~~~~~~> local variables
  ...
  !   write(*,*)'[DEBUG prolong3] ghost_width==4 (8-pt, line 2768) called, extc=',extc,' extf=',extf
  if(wei.ne.3)then
     write(*,*)"prolongrestrict.f90::prolong3: this routine only surport 3 dimension"
     write(*,*)"dim = ",wei
     stop
...
!~~~~~~> local variables
  ...
  !   write(*,*)'[DEBUG prolong3] ghost_width==5 (10-pt, line 3294) called, extc=',extc,' extf=',extf
  if(wei.ne.3)then
     write(*,*)"prolongrestrict.f90::prolong3: this routine only surport 3 dimension"
     write(*,*)"dim = ",wei
     stop
