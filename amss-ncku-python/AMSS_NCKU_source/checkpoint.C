...
// 该成员函数用于检查和写入 shell-patch 的网格信息
...
// 该成员函数用于阅读和检查 shell-patch 的网格信息
...
// 该成员函数用于写入 BSSN 变量的信息（没有定义 CHECKDETAIL的情形）？
...
// 该成员函数用于读入 BSSN 变量的信息（没有定义 CHECKDETAIL的情形）？
...
// 该成员函数用于读入黑洞的位置信息（没有定义 CHECKDETAIL的情形）
...
// 该成员函数用于检查和写入网格信息（没有定义 CHECKDETAIL的情形）
...
// 该成员函数用于读入和检查网格信息（没有定义 CHECKDETAIL的情形）
