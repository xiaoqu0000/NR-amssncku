...
!$OMP PRIVATE(i,j,k,bhi,M,Q,Px,Py,Pz,PP,Sx,Sy,Sz,SS,nx,ny,nz,rr,tmp,u,u1,u2,u3,u4,mup,mus,b,ell)
  do k = 1,ext(3)
   do j = 1,ext(2)
    do i = 1,ext(1)
! black hole 1
...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,bhi,M,Q,Px,Py,Pz,Sx,Sy,Sz,nx,ny,nz,rr,tmp)
  do k = 1,ext(3)
   do j = 1,ext(2)
    do i = 1,ext(1)
! black hole 1
