...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,sr,ss,cr,cs,sr2,ss2,cr2,cs2,ggr,tgrho,tgsigma,x,y,z,gr,gt,gp)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
     sr = dsin(crho(i))
...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,sr,ss,cr,cs,sr2,ss2,cr2,cs2,tg22,tg23,tg33)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
     sr = dsin(crho(i))
...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,fr,fs,frr,fss,frs,covf)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
...
!$OMP PRIVATE(i,j,k,sr,ss,cr,cs,sr2,ss2,cr2,cs2,ggr,tgrho,tgsigma,x,y,z,gr,gt,gp,gxx,gxy,gyy,tc,ts,swtf,z220,mx,my,mlx,mly,Jr,ctp)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
     sr = dsin(crho(i))
...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) &
!$OMP PRIVATE(i,j,k,sr,ss,cr,cs,sr2,ss2,cr2,cs2,ggr,tgrho,tgsigma,x,y,z,gr,gt,gp,tc,ts,swtf,z020,z120,z220,Jr,Ur,Wr)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
     sr = dsin(crho(i))
...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) &
!$OMP PRIVATE(i,j,k,sr,ss,cr,cs,sr2,ss2,cr2,cs2,ggr,tgrho,tgsigma, &
!$OMP         x,y,z,gr,gt,gp,gxx,gxy,gyy,tc,ts,swtf,z020,z120,z220,mx,my,mlx,mly,Jr,Jrp,Jrt,Ur,Urp,Wr,ctp)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
     sr = dsin(crho(i))
