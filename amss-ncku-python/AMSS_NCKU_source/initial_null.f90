...
call initial_null_paramter(beta0,C1,C2,nu,m)
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,x,y,z,gr,gt,gp,tgrho,tgsigma,tc,ts,Jr,swtf,ff)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
...
call initial_null_paramter(beta0,C1,C2,nu,m)
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,x,y,z,hgr,gt,gp,tgrho,tgsigma,tc,ts,Jr,swtf,ff)
  do i=1,ex(1) 
  do j=1,ex(2)
  do k=1,ex(3)
! fake global coordinate is enough here
...
!         stop
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,x,y,z,hgr,gt,gp,tgrho,tgsigma,tc,ts,rf,Jr,swtf,ff)
  do i=1,ex(1)
  do j=1,ex(2)
  do k=1,ex(3)
!fake global coordinate is enough here  
