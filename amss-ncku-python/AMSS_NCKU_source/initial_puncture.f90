...
!$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,x,y,z)
do i=1,ex(1)
do j=1,ex(2)
do k=1,ex(3)
  x = XX(i,j,k)
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) &
  !$OMP PRIVATE(i,j,k,Px,Py,Pz,PP,Sx,Sy,Sz,SS,nx,ny,nz,rr,tmp,u,u1,u2,u3,u4,mup,mus,b,ell)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,M,Px,Py,Pz,PP,Sx,Sy,Sz,SS,nx,ny,nz,rr,tmp,u,u1,u2,u3,u4,mup,mus,b,ell)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
! black hole 1
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,Px,Py,Pz,Sx,Sy,Sz,nx,ny,nz,rr,tmp)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,M,Px,Py,Pz,Sx,Sy,Sz,nx,ny,nz,rr,tmp)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
! black hole 1
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) PRIVATE(i,j,k,bhi,M,Px,Py,Pz,Sx,Sy,Sz,nx,ny,nz,rr,tmp)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
! black hole 1
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) &
  !$OMP PRIVATE(i,j,k,bhi,M,Px,Py,Pz,PP,Sx,Sy,Sz,SS,nx,ny,nz,rr,tmp,u,u1,u2,u3,u4,mup,mus,b,ell)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
! black hole 1
...
!------= local variables
  ...
  !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(SHARED) &
  !$OMP PRIVATE(i,j,k,bhi,M,Px,Py,Pz,PP,Sx,Sy,Sz,SS,nx,ny,nz,rr,tmp,u,u1,u2,u3,u4,u5,mup,mus,b,ell)
  do k = 1,ex(3)
   do j = 1,ex(2)
    do i = 1,ex(1)
! black hole 1
