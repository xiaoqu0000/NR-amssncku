//$Id: TwoPunctures.C,v 1.1.1.1 2017/09/25 02:35:55 zjcao Exp $
#ifdef newc
#include <assert.h>
#include <ctype.h>
#include <cstdio>
...
void TwoPunctures::Save(char *fname)
{
  ...
  outfile<<"bhx1         = "<< x1<<endl;
  outfile<<"bhy1         = "<< 0<<endl;
  outfile<<"bhz1         = "<< 0<<endl;
  outfile<<"bhpx1        = "<< par_P_plus[0]<<endl;
  outfile<<"bhpy1        = "<< par_P_plus[1]<<endl;
  outfile<<"bhpz1        = "<< par_P_plus[2]<<endl;
  outfile<<"bhsx1        = "<< par_S_plus[0]<<endl;
  outfile<<"bhsy1        = "<< par_S_plus[1]<<endl;
  outfile<<"bhsz1        = "<< par_S_plus[2]<<endl;
  outfile<<"bhmass2      = "<< par_m_minus<<endl;
  outfile<<"bhx2         = "<< x2<<endl;
  outfile<<"bhy2         = "<< 0<<endl;
  outfile<<"bhz2         = "<< 0<<endl;
  outfile<<"bhpx2        = "<< par_P_minus[0]<<endl;
  outfile<<"bhpy2        = "<< par_P_minus[1]<<endl;
  outfile<<"bhpz2        = "<< par_P_minus[2]<<endl;
  outfile<<"bhsx2        = "<< par_S_minus[0]<<endl;
  outfile<<"bhsy2        = "<< par_S_minus[1]<<endl;
...
#if 0
  outfile.open("TwPxyz.dat",ios::trunc);
  outfile.setf(ios::scientific,ios::floatfield);
  outfile.precision( 16 );
  outfile<<"#xyz coordinate for TwoPunctures output"<<endl;
