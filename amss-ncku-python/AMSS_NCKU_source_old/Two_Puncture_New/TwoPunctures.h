//$Id: TwoPunctures.h,v 1.1.1.1 2017/09/25 02:35:55 zjcao Exp $
   ...
   class TwoPunctures
{
  ...
  private:
	...
	double b;
     ...
     void ABp_to_xyz(const double A,const double B,const double phi,
  ...
  public:
       ...
       void write_Pablo_file(const int *ext,
		                    const double xmin,const double xmax,
				    const double ymin,const double ymax,
				    const double zmin,const double zmax,
	       			    const char *filename);

       void write_Pablo_file_F(const int *ext,
		                    const double xmin,const double xmax,
				    const double ymin,const double ymax,
				    const double zmin,const double zmax,
	       			    const char *filename);
  ...
  private:       
       ...
       double PunctIntPolAtArbitPosition (int ivar, int nvar, int n1,
			    ...
			    double z);
       double PunctIntPolAtArbitPosition_F(int ivar, int nvar, int n1,
